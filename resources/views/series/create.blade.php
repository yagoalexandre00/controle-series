    ...
    <div class="create-form">
        <form action="/series" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="platform" name="platform" placeholder="Ex.: Netflix, Amazon, Disney...">

            </div>
            <div class="form-group">
                <label for="year">Ano de lançamento</label>
                <input type="text" class="form-control" id="year" name="year" placeholder="Ano exato de lançamento do filme">
            </div>
